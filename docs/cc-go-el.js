...
var MainGoEl = function() {
	this.idArr = ["container-hero-html","astronaut","rocket","saturnring","planet"];
...
MainGoEl.prototype = {
	...
	,collectDefault: function() {
		...
		console.log("src/MainGoEl.hx:54:",this.elementMap == null ? "null" : haxe_ds_StringMap.stringify(this.elementMap.h));
	}
...
cc_lets_GoEl.frames = function(frames) {
	var GoEl = new cc_lets_GoEl(new HTMLElement(),frames * 60);
	return GoEl;
};
...
cc_lets_GoEl.prototype = {
	isTimeBased: function(isTimeBased) {
		...
		console.log("cc/lets/GoEl.hx:252:","Fixme: this doesn\t work right now");
