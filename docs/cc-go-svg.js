...
var MainGoSVG = function() {
	...
	window.document.addEventListener("DOMContentLoaded",function(event) {
		$global.console.info("MainGoSVG - " + model_constants_App.NAME + " Dom ready :: build: " + "2024-03-08 17:25:06" + " ");
...
MainGoSVG.prototype = {
	...
	,convertSrcToSVG: function() {
		...
		http.onError = function(error) {
			haxe_Log.trace("Failed to load SVG: " + error,{ fileName : "src/MainGoSVG.hx", lineNumber : 83, className : "MainGoSVG", methodName : "convertSrcToSVG"});
		};
		http.request();
	}
	,getDataSBG: function() {
